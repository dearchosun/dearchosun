...
<?php } ?>
<!--#Meta:layouts/sketchbook5/css/layout.css--><?php $__tmp=array('layouts/sketchbook5/css/layout.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->layout_info->colorset=='black'){ ?><!--#Meta:layouts/sketchbook5/css/black.css--><?php $__tmp=array('layouts/sketchbook5/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
<!--#Meta:layouts/sketchbook5/js/layout.js--><?php $__tmp=array('layouts/sketchbook5/js/layout.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
echo $__Context->lang->best_font;
			...
			<?php if(!$__Context->is_logged){ ?><li class="item">
				...
				<div id="site_login" class="tg_cnt">
					<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('layouts/sketchbook5','login.html') ?>
				</div>
			</li><?php } ?>
			<li class="item">
		...
		<div id="gnb_wrp" class="clear">
			...
			<div id="site_srch" class="srch">
				<form action="<?php echo getUrl() ?>" method="get"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" />
					...
					<input type="image" src="/xe/layouts/sketchbook5/img/bs_<?php echo $__Context->layout_info->colorset ?>.png" alt="Search" class="is" />
				</form>
			</div>
			<!-- GNB -->
