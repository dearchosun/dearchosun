...
<?php } ?>
<!--#Meta:widgets/soo_kma_rss/skins/mini_icon2/css/css.css--><?php $__tmp=array('widgets/soo_kma_rss/skins/mini_icon2/css/css.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<h3 class="soo_weather"><i class="xi-sunset"></i> <?php echo $__Context->location ?> <?php echo $__Context->lang->soo_tomorrow ?>(<?php echo intval(date('m',$__Context->datas->pubtime)) ?>/<?php echo intval(date('d',$__Context->datas->pubtime))+1 ?>) <?php echo $__Context->lang->soo_weather ?> <a href="<?php echo $__Context->datas->link ?>" onclick="window.open(this.href);return false"><?php echo $__Context->lang->detail_view ?></a></h3>
<?php $__Context->time_arr = array(9,12,18,21) ?>
...
<div class="soo_weather_footer"><?php echo $__Context->lang->soo_pubtime ?>: <?php echo date('m/d H:i',$__Context->datas->pubtime) ?>, <address><?php echo $__Context->lang->soo_copyright ?>: <a href="http://www.kma.go.kr" onclick="window.open(this.href);return false"><?php echo $__Context->lang->soo_kma ?></a></address></div>